const applicationConfig = {
  ...
  AUTH_ME_ENDPOINT: 'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/v1/private/me/',
  CATEGORIES_ENDPOINT:
    'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/v1/public/terms/categories/',
  CATEGORIES_PRIVATE_ENDPOINT:
    'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/v1/private/categories/',
  DEPARTMENTS_ENDPOINT: 'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/v1/private/departments/',
  FEEDBACK_FORMS_ENDPOINT:
    'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/v1/public/feedback/forms/',
  FEEDBACK_STANDARD_ANSWERS_ENDPOINT:
    'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/v1/public/feedback/standard_answers/',
  FILTERS_ENDPOINT: 'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/v1/private/me/filters/',
  GEOGRAPHY_ENDPOINT:
    'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/v1/private/signals/geography',
  IMAGE_ENDPOINT: 'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/signal/image/',
  INCIDENTS_ENDPOINT: 'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/v1/private/signals/',
  INCIDENT_PRIVATE_ENDPOINT:
    'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/v1/private/signals/',
  INCIDENT_PUBLIC_ENDPOINT: 'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/v1/public/signals/',
  OIDC_AUTH_ENDPOINT: 'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/oauth2/authorize',
  OIDC_CLIENT_ID: 'sia',
  ...
  PERMISSIONS_ENDPOINT: 'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/v1/private/permissions/',
  PREDICTION_ENDPOINT: 'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/category/prediction',
  QUESTIONS_ENDPOINT: 'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/v1/public/questions/',
  ROLES_ENDPOINT: 'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/v1/private/roles/',
  SEARCH_ENDPOINT: 'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/v1/private/search',
  TERMS_ENDPOINT: 'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/v1/private/terms/categories/',
  USERS_ENDPOINT: 'http://ec2-15-207-50-40.ap-south-1.compute.amazonaws.com:8000/signals/v1/private/users/',
  default: 'Testing',
};
